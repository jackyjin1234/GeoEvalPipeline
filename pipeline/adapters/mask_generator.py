...
class MaskGeneratorAdapter:
    ...
    def __init__(self, target_features: List[str], combine_masks: bool = False, 
    ...
    def _validate_features(self):
        ...
        try:
            ...
            selected_labels = getSelectedLabels(categories=self.target_features, label_names=None)
    ...
    def _create_combined_mask(self, annotation: Annotation, features: List[str]):
        ...
        selected_labels = getSelectedLabels(categories=features, label_names=None)
    ...
    def _create_feature_mask(self, annotation: Annotation, feature: str):
        ...
        selected_labels = getSelectedLabels(categories=[feature], label_names=None)
